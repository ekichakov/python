#Звездный треугольник 🌶️🌶️. Дано нечетное натуральное число nnn. Напишите программу, которая печатает равнобедренный звездный треугольник с основанием, равным nnn в соответствии с примером:
#*
#**
#***
#****
