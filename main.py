...
# Не РЕШЕНА Наибольшие числа. На вход программе подается натуральное число n, а затем nnn различных натуральных чисел, каждое на отдельной строке.(n≥2). Напишите программу, которая выводит наибольшее и второе наибольшее число последовательности.
#n = int(input())
#largest, largest_1, largest_2 = 0, 0, 0 
#for i in range(n):
#    num = int(input())
#    if num > largest:
#        largest_1 = num
